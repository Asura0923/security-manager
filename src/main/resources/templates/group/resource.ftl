                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-footer" style="">
                            <form class="form-horizontal" onsubmit="return preForm();"
                                  action="${request.contextPath}/security/group/resource" method="post">
                                <input name="id" value="${securityGroup.id?c}" style="display: none;" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10 col-lg-11">
                                            <input class="form-control" id="name" name="name" placeholder="请填写组织名称"
                                                   required value="${securityGroup.name!}" readonly>
                                        </div>
                                    </div>
