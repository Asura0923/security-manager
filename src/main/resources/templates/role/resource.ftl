                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-footer" style="">
                            <form class="form-horizontal" onsubmit="return preForm();"
                                  action="${request.contextPath}/security/role/resource" method="post">
                                <input name="id" value="${securityRole.id?c}" style="display: none;" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10 col-lg-11">
                                            <input class="form-control" id="name" name="name" placeholder="请填写用户名称"
                                                   required value="${securityRole.name!}" readonly>
                                        </div>
                                    </div>
